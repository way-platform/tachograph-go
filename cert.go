...
// Deprecated: Use CertificateResolver instead.
// CertificateStore is the old name for CertificateResolver.
type CertificateStore = CertificateResolver

// Deprecated: Use DefaultCertificateResolver instead.
// DefaultCertificateStore returns the default certificate resolver.
func DefaultCertificateStore() CertificateStore {
	return DefaultCertificateResolver()
}
