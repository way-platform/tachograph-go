...
// 	protoc        (unknown)
// source: wayplatform/connect/tachograph/datadictionary/v1/encoding.proto
...
func (Encoding) Descriptor() protoreflect.EnumDescriptor {
	return file_wayplatform_connect_tachograph_datadictionary_v1_encoding_proto_enumTypes[0].Descriptor()
}

func (Encoding) Type() protoreflect.EnumType {
	return &file_wayplatform_connect_tachograph_datadictionary_v1_encoding_proto_enumTypes[0]
}
...
var File_wayplatform_connect_tachograph_datadictionary_v1_encoding_proto protoreflect.FileDescriptor

const file_wayplatform_connect_tachograph_datadictionary_v1_encoding_proto_rawDesc = "" +
	"\n" +
	"?wayplatform/connect/tachograph/datadictionary/v1/encoding.proto\x120wayplatform.connect.tachograph.datadictionary.v1\x1aBwayplatform/connect/tachograph/datadictionary/v1/annotations.proto*\xf9\x02\n" +
	"\bEncoding\x12\x18\n" +
	...
	"\x06KOI8_U\x10\x0f\x1a\x05\xa0\xaf\x9c\x02UB\xa0\x03\n" +
	"4com.wayplatform.connect.tachograph.datadictionary.v1B\rEncodingProtoP\x01Ztgithub.com/way-platform/tachograph-go/proto/gen/go/wayplatform/connect/tachograph/datadictionary/v1;datadictionaryv1\xa2\x02\x04WCTD\xaa\x020Wayplatform.Connect.Tachograph.Datadictionary.V1\xca\x020Wayplatform\\Connect\\Tachograph\\Datadictionary\\V1\xe2\x02<Wayplatform\\Connect\\Tachograph\\Datadictionary\\V1\\GPBMetadata\xea\x024Wayplatform::Connect::Tachograph::Datadictionary::V1b\x06proto3"

var file_wayplatform_connect_tachograph_datadictionary_v1_encoding_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_wayplatform_connect_tachograph_datadictionary_v1_encoding_proto_goTypes = []any{
	(Encoding)(0), // 0: wayplatform.connect.tachograph.datadictionary.v1.Encoding
}
var file_wayplatform_connect_tachograph_datadictionary_v1_encoding_proto_depIdxs = []int32{
...
func init() { file_wayplatform_connect_tachograph_datadictionary_v1_encoding_proto_init() }
func file_wayplatform_connect_tachograph_datadictionary_v1_encoding_proto_init() {
	if File_wayplatform_connect_tachograph_datadictionary_v1_encoding_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wayplatform_connect_tachograph_datadictionary_v1_encoding_proto_rawDesc), len(file_wayplatform_connect_tachograph_datadictionary_v1_encoding_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wayplatform_connect_tachograph_datadictionary_v1_encoding_proto_goTypes,
		DependencyIndexes: file_wayplatform_connect_tachograph_datadictionary_v1_encoding_proto_depIdxs,
		EnumInfos:         file_wayplatform_connect_tachograph_datadictionary_v1_encoding_proto_enumTypes,
	}.Build()
	File_wayplatform_connect_tachograph_datadictionary_v1_encoding_proto = out.File
	file_wayplatform_connect_tachograph_datadictionary_v1_encoding_proto_goTypes = nil
	file_wayplatform_connect_tachograph_datadictionary_v1_encoding_proto_depIdxs = nil
}
