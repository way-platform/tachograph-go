...
// 	protoc        (unknown)
// source: wayplatform/connect/tachograph/datadictionary/v1/bcd_string.proto
...
func (x *BcdString) Reset() {
	*x = BcdString{}
	mi := &file_wayplatform_connect_tachograph_datadictionary_v1_bcd_string_proto_msgTypes[0]
...
var File_wayplatform_connect_tachograph_datadictionary_v1_bcd_string_proto protoreflect.FileDescriptor

const file_wayplatform_connect_tachograph_datadictionary_v1_bcd_string_proto_rawDesc = "" +
	"\n" +
	"Awayplatform/connect/tachograph/datadictionary/v1/bcd_string.proto\x120wayplatform.connect.tachograph.datadictionary.v1\"?\n" +
	"\tBcdString\x12\x18\n" +
	"\aencoded\x18\x01 \x01(\fR\aencoded\x12\x18\n" +
	"\adecoded\x18\x02 \x01(\x05R\adecodedB\xa1\x03\n" +
	"4com.wayplatform.connect.tachograph.datadictionary.v1B\x0eBcdStringProtoP\x01Ztgithub.com/way-platform/tachograph-go/proto/gen/go/wayplatform/connect/tachograph/datadictionary/v1;datadictionaryv1\xa2\x02\x04WCTD\xaa\x020Wayplatform.Connect.Tachograph.Datadictionary.V1\xca\x020Wayplatform\\Connect\\Tachograph\\Datadictionary\\V1\xe2\x02<Wayplatform\\Connect\\Tachograph\\Datadictionary\\V1\\GPBMetadata\xea\x024Wayplatform::Connect::Tachograph::Datadictionary::V1b\beditionsp\xe8\a"

var file_wayplatform_connect_tachograph_datadictionary_v1_bcd_string_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_wayplatform_connect_tachograph_datadictionary_v1_bcd_string_proto_goTypes = []any{
	(*BcdString)(nil), // 0: wayplatform.connect.tachograph.datadictionary.v1.BcdString
}
var file_wayplatform_connect_tachograph_datadictionary_v1_bcd_string_proto_depIdxs = []int32{
...
func init() { file_wayplatform_connect_tachograph_datadictionary_v1_bcd_string_proto_init() }
func file_wayplatform_connect_tachograph_datadictionary_v1_bcd_string_proto_init() {
	if File_wayplatform_connect_tachograph_datadictionary_v1_bcd_string_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wayplatform_connect_tachograph_datadictionary_v1_bcd_string_proto_rawDesc), len(file_wayplatform_connect_tachograph_datadictionary_v1_bcd_string_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wayplatform_connect_tachograph_datadictionary_v1_bcd_string_proto_goTypes,
		DependencyIndexes: file_wayplatform_connect_tachograph_datadictionary_v1_bcd_string_proto_depIdxs,
		MessageInfos:      file_wayplatform_connect_tachograph_datadictionary_v1_bcd_string_proto_msgTypes,
	}.Build()
	File_wayplatform_connect_tachograph_datadictionary_v1_bcd_string_proto = out.File
	file_wayplatform_connect_tachograph_datadictionary_v1_bcd_string_proto_goTypes = nil
	file_wayplatform_connect_tachograph_datadictionary_v1_bcd_string_proto_depIdxs = nil
}
