...
// 	protoc        (unknown)
// source: wayplatform/connect/tachograph/dd/v1/equipment_type.proto
...
func (EquipmentType) Descriptor() protoreflect.EnumDescriptor {
	return file_wayplatform_connect_tachograph_dd_v1_equipment_type_proto_enumTypes[0].Descriptor()
}

func (EquipmentType) Type() protoreflect.EnumType {
	return &file_wayplatform_connect_tachograph_dd_v1_equipment_type_proto_enumTypes[0]
}
...
var File_wayplatform_connect_tachograph_dd_v1_equipment_type_proto protoreflect.FileDescriptor

const file_wayplatform_connect_tachograph_dd_v1_equipment_type_proto_rawDesc = "" +
	"\n" +
	"9wayplatform/connect/tachograph/dd/v1/equipment_type.proto\x12$wayplatform.connect.tachograph.dd.v1\x1a6wayplatform/connect/tachograph/dd/v1/annotations.proto*\x8d\x05\n" +
	...
	"\x11VEHICLE_UNIT_SIGN\x10\x15\x1a\x05\x98\xaf\x9c\x02\x13B\xd1\x02\n" +
	"(com.wayplatform.connect.tachograph.dd.v1B\x12EquipmentTypeProtoP\x01Z\\github.com/way-platform/tachograph-go/proto/gen/go/wayplatform/connect/tachograph/dd/v1;ddv1\xa2\x02\x04WCTD\xaa\x02$Wayplatform.Connect.Tachograph.Dd.V1\xca\x02$Wayplatform\\Connect\\Tachograph\\Dd\\V1\xe2\x020Wayplatform\\Connect\\Tachograph\\Dd\\V1\\GPBMetadata\xea\x02(Wayplatform::Connect::Tachograph::Dd::V1b\beditionsp\xe8\a"

var file_wayplatform_connect_tachograph_dd_v1_equipment_type_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_wayplatform_connect_tachograph_dd_v1_equipment_type_proto_goTypes = []any{
	(EquipmentType)(0), // 0: wayplatform.connect.tachograph.dd.v1.EquipmentType
}
var file_wayplatform_connect_tachograph_dd_v1_equipment_type_proto_depIdxs = []int32{
...
func init() { file_wayplatform_connect_tachograph_dd_v1_equipment_type_proto_init() }
func file_wayplatform_connect_tachograph_dd_v1_equipment_type_proto_init() {
	if File_wayplatform_connect_tachograph_dd_v1_equipment_type_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wayplatform_connect_tachograph_dd_v1_equipment_type_proto_rawDesc), len(file_wayplatform_connect_tachograph_dd_v1_equipment_type_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wayplatform_connect_tachograph_dd_v1_equipment_type_proto_goTypes,
		DependencyIndexes: file_wayplatform_connect_tachograph_dd_v1_equipment_type_proto_depIdxs,
		EnumInfos:         file_wayplatform_connect_tachograph_dd_v1_equipment_type_proto_enumTypes,
	}.Build()
	File_wayplatform_connect_tachograph_dd_v1_equipment_type_proto = out.File
	file_wayplatform_connect_tachograph_dd_v1_equipment_type_proto_goTypes = nil
	file_wayplatform_connect_tachograph_dd_v1_equipment_type_proto_depIdxs = nil
}
