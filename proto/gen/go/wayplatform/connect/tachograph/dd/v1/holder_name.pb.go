...
// 	protoc        (unknown)
// source: wayplatform/connect/tachograph/dd/v1/holder_name.proto
...
func (x *HolderName) Reset() {
	*x = HolderName{}
	mi := &file_wayplatform_connect_tachograph_dd_v1_holder_name_proto_msgTypes[0]
...
var File_wayplatform_connect_tachograph_dd_v1_holder_name_proto protoreflect.FileDescriptor
...
var file_wayplatform_connect_tachograph_dd_v1_holder_name_proto_goTypes = []any{
	(*HolderName)(nil),  // 0: wayplatform.connect.tachograph.dd.v1.HolderName
	(*StringValue)(nil), // 1: wayplatform.connect.tachograph.dd.v1.StringValue
}
var file_wayplatform_connect_tachograph_dd_v1_holder_name_proto_depIdxs = []int32{
	1, // 0: wayplatform.connect.tachograph.dd.v1.HolderName.holder_surname:type_name -> wayplatform.connect.tachograph.dd.v1.StringValue
	1, // 1: wayplatform.connect.tachograph.dd.v1.HolderName.holder_first_names:type_name -> wayplatform.connect.tachograph.dd.v1.StringValue
...
func init() { file_wayplatform_connect_tachograph_dd_v1_holder_name_proto_init() }
func file_wayplatform_connect_tachograph_dd_v1_holder_name_proto_init() {
	if File_wayplatform_connect_tachograph_dd_v1_holder_name_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wayplatform_connect_tachograph_dd_v1_holder_name_proto_rawDesc), len(file_wayplatform_connect_tachograph_dd_v1_holder_name_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wayplatform_connect_tachograph_dd_v1_holder_name_proto_goTypes,
		DependencyIndexes: file_wayplatform_connect_tachograph_dd_v1_holder_name_proto_depIdxs,
		MessageInfos:      file_wayplatform_connect_tachograph_dd_v1_holder_name_proto_msgTypes,
	}.Build()
	File_wayplatform_connect_tachograph_dd_v1_holder_name_proto = out.File
	file_wayplatform_connect_tachograph_dd_v1_holder_name_proto_goTypes = nil
	file_wayplatform_connect_tachograph_dd_v1_holder_name_proto_depIdxs = nil
}
