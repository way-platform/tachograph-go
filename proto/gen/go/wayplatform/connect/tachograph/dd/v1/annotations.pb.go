...
// 	protoc        (unknown)
// source: wayplatform/connect/tachograph/dd/v1/annotations.proto
...
var file_wayplatform_connect_tachograph_dd_v1_annotations_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		ExtendedType:  (*descriptorpb.EnumValueOptions)(nil),
		ExtensionType: (*int32)(nil),
		Field:         582387,
		Name:          "wayplatform.connect.tachograph.dd.v1.protocol_enum_value",
	...
	},
	{
		...
		ExtensionType: (*int32)(nil),
		Field:         582388,
		Name:          "wayplatform.connect.tachograph.dd.v1.code_page",
...
const file_wayplatform_connect_tachograph_dd_v1_annotations_proto_rawDesc = "" +
	"\n" +
...
func init() { file_wayplatform_connect_tachograph_dd_v1_annotations_proto_init() }
func file_wayplatform_connect_tachograph_dd_v1_annotations_proto_init() {
	if File_wayplatform_connect_tachograph_dd_v1_annotations_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		DependencyIndexes: file_wayplatform_connect_tachograph_dd_v1_annotations_proto_depIdxs,
		ExtensionInfos:    file_wayplatform_connect_tachograph_dd_v1_annotations_proto_extTypes,
	}.Build()
	File_wayplatform_connect_tachograph_dd_v1_annotations_proto = out.File
	file_wayplatform_connect_tachograph_dd_v1_annotations_proto_goTypes = nil
	file_wayplatform_connect_tachograph_dd_v1_annotations_proto_depIdxs = nil
}
