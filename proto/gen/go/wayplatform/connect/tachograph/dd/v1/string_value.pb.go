...
type StringValue struct {
	...
	xxx_hidden_Encoding Encoding               `protobuf:"varint,1,opt,name=encoding,proto3,enum=wayplatform.connect.tachograph.dd.v1.Encoding"`
...
const file_wayplatform_connect_tachograph_dd_v1_string_value_proto_rawDesc = "" +
	"\n" +
	"7wayplatform/connect/tachograph/dd/v1/string_value.proto\x12$wayplatform.connect.tachograph.dd.v1\x1a3wayplatform/connect/tachograph/dd/v1/encoding.proto\"\x8d\x01\n" +
	"\vStringValue\x12J\n" +
	"\bencoding\x18\x01 \x01(\x0e2..wayplatform.connect.tachograph.dd.v1.EncodingR\bencoding\x12\x18\n" +
	"\aencoded\x18\x02 \x01(\fR\aencoded\x12\x18\n" +
	"\adecoded\x18\x03 \x01(\tR\adecodedB\xcf\x02\n" +
