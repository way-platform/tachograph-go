...
// 	protoc        (unknown)
// source: wayplatform/connect/tachograph/card/v1/control_application_identification.proto
...
func (x *ControlApplicationIdentification) Reset() {
	*x = ControlApplicationIdentification{}
	mi := &file_wayplatform_connect_tachograph_card_v1_control_application_identification_proto_msgTypes[0]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ControlApplicationIdentification) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ControlApplicationIdentification) ProtoMessage() {}

func (x *ControlApplicationIdentification) ProtoReflect() protoreflect.Message {
	mi := &file_wayplatform_connect_tachograph_card_v1_control_application_identification_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
func (x *ControlApplicationIdentification) GetCardStructureVersion() []byte {
	if x != nil {
...
func (x *ControlApplicationIdentification) GetControlActivityRecordsCount() int32 {
	if x != nil {
...
func (b0 ControlApplicationIdentification_builder) Build() *ControlApplicationIdentification {
	m0 := &ControlApplicationIdentification{}
	b, x := &b0, m0
	_, _ = b, x
...
var File_wayplatform_connect_tachograph_card_v1_control_application_identification_proto protoreflect.FileDescriptor

const file_wayplatform_connect_tachograph_card_v1_control_application_identification_proto_rawDesc = "" +
	"\n" +
	"Owayplatform/connect/tachograph/card/v1/control_application_identification.proto\x12&wayplatform.connect.tachograph.card.v1\x1aEwayplatform/connect/tachograph/datadictionary/v1/equipment_type.proto\"\x9a\x02\n" +
...
func file_wayplatform_connect_tachograph_card_v1_control_application_identification_proto_init() {
	if File_wayplatform_connect_tachograph_card_v1_control_application_identification_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wayplatform_connect_tachograph_card_v1_control_application_identification_proto_rawDesc), len(file_wayplatform_connect_tachograph_card_v1_control_application_identification_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wayplatform_connect_tachograph_card_v1_control_application_identification_proto_goTypes,
		DependencyIndexes: file_wayplatform_connect_tachograph_card_v1_control_application_identification_proto_depIdxs,
		MessageInfos:      file_wayplatform_connect_tachograph_card_v1_control_application_identification_proto_msgTypes,
	}.Build()
	File_wayplatform_connect_tachograph_card_v1_control_application_identification_proto = out.File
	file_wayplatform_connect_tachograph_card_v1_control_application_identification_proto_goTypes = nil
	file_wayplatform_connect_tachograph_card_v1_control_application_identification_proto_depIdxs = nil
}
