...
const file_wayplatform_connect_tachograph_card_v1_card_ma_certificate_proto_rawDesc = "" +
	"\n" +
	"@wayplatform/connect/tachograph/card/v1/card_ma_certificate.proto\x12&wayplatform.connect.tachograph.card.v1\x1a:wayplatform/connect/tachograph/dd/v1/ecc_certificate.proto\"r\n" +
	"\x11CardMaCertificate\x12]\n" +
	"\x0fecc_certificate\x18\x01 \x01(\v24.wayplatform.connect.tachograph.dd.v1.EccCertificateR\x0eeccCertificateB\xe3\x02\n" +
...
var file_wayplatform_connect_tachograph_card_v1_card_ma_certificate_proto_depIdxs = []int32{
	1, // 0: wayplatform.connect.tachograph.card.v1.CardMaCertificate.ecc_certificate:type_name -> wayplatform.connect.tachograph.dd.v1.EccCertificate
