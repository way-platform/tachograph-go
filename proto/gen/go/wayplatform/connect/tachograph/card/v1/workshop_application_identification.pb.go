...
// 	protoc        (unknown)
// source: wayplatform/connect/tachograph/card/v1/workshop_application_identification.proto
...
var File_wayplatform_connect_tachograph_card_v1_workshop_application_identification_proto protoreflect.FileDescriptor

const file_wayplatform_connect_tachograph_card_v1_workshop_application_identification_proto_rawDesc = "" +
	"\n" +
	"Pwayplatform/connect/tachograph/card/v1/workshop_application_identification.proto\x12&wayplatform.connect.tachograph.card.v1\x1aEwayplatform/connect/tachograph/datadictionary/v1/equipment_type.proto\"\xae\x04\n" +
...
func file_wayplatform_connect_tachograph_card_v1_workshop_application_identification_proto_init() {
	if File_wayplatform_connect_tachograph_card_v1_workshop_application_identification_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wayplatform_connect_tachograph_card_v1_workshop_application_identification_proto_rawDesc), len(file_wayplatform_connect_tachograph_card_v1_workshop_application_identification_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wayplatform_connect_tachograph_card_v1_workshop_application_identification_proto_goTypes,
		DependencyIndexes: file_wayplatform_connect_tachograph_card_v1_workshop_application_identification_proto_depIdxs,
		MessageInfos:      file_wayplatform_connect_tachograph_card_v1_workshop_application_identification_proto_msgTypes,
	}.Build()
	File_wayplatform_connect_tachograph_card_v1_workshop_application_identification_proto = out.File
	file_wayplatform_connect_tachograph_card_v1_workshop_application_identification_proto_goTypes = nil
	file_wayplatform_connect_tachograph_card_v1_workshop_application_identification_proto_depIdxs = nil
}
