...
func (x *VehiclesUsedG2) GetSignatureVerified() bool {
	if x != nil {
...
func (x *VehiclesUsedG2) SetSignatureVerified(v bool) {
...
func (x *VehiclesUsedG2) HasSignatureVerified() bool {
	if x == nil {
		return false
	}
...
func (x *VehiclesUsedG2) ClearSignatureVerified() {
...
const file_wayplatform_connect_tachograph_card_v1_vehicles_used_g2_proto_rawDesc = "" +
	"\n" +
	"=wayplatform/connect/tachograph/card/v1/vehicles_used_g2.proto\x12&wayplatform.connect.tachograph.card.v1\x1aAwayplatform/connect/tachograph/dd/v1/card_vehicle_record_g2.proto\"\xfd\x01\n" +
	...
	"\x12signature_verified\x18\x05 \x01(\bR\x11signatureVerifiedB\xe0\x02\n" +
