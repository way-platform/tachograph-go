...
const file_wayplatform_connect_tachograph_card_v1_events_data_proto_rawDesc = "" +
	...
	"\n" +
	"event_type\x18\x02 \x01(\x0e2@.wayplatform.connect.tachograph.datadictionary.v1.EventFaultTypeR\teventType\x12D\n" +
	"\x10event_begin_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x0eeventBeginTime\x12@\n" +
	"\x0eevent_end_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\feventEndTime\x12\x91\x01\n" +
	"\x1aevent_vehicle_registration\x18\x06 \x01(\v2S.wayplatform.connect.tachograph.datadictionary.v1.VehicleRegistrationIdentificationR\x18eventVehicleRegistration\x12\x19\n" +
...
var file_wayplatform_connect_tachograph_card_v1_events_data_proto_depIdxs = []int32{
	...
	2, // 1: wayplatform.connect.tachograph.card.v1.EventsData.Record.event_type:type_name -> wayplatform.connect.tachograph.datadictionary.v1.EventFaultType
	...
	4, // 4: wayplatform.connect.tachograph.card.v1.EventsData.Record.event_vehicle_registration:type_name -> wayplatform.connect.tachograph.datadictionary.v1.VehicleRegistrationIdentification
